...
- [List by Area](#list-by-area)
  - [Statistical Machine Translation](#Statistical Machine Translation)
    ...
    - [Distortion-based and Fertility-based models](#Distortion-based and Fertility-based models)
    - [Phrase-based Models](#Phrase-based Models)
    - [Syntax-based Models](#Syntax-based Models)
